...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        avatarInputConverter.avatarHandLeft = loadableAvatarModels[avatarIndex].GetComponent<AvatarHolder>().HandLeftTransform;
        avatarInputConverter.avatarHandRight = loadableAvatarModels[avatarIndex].GetComponent<AvatarHolder>().HandRightTransform;
